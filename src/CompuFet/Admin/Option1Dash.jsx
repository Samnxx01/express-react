...
function Option1Dash() {
    return (
        <div>
            <div>
                <div className="box-container">

                    <div className="box001 box1">
                        <div className="text">
                ...
                <div className="report-container">
                    <div className="report-header">
                        ...
                        <button className="view001">View All</button>
                    </div>
